...
public interface AlertApiDocs {
    ...
    Response<Void> appendAlertMethod(AppendAlertMethodRequest request);
    ...
    Response<Void> deactivateAlertMethod(Long alertMethodId);

    @Operation(summary = "알림 수단 활성화", description = "알림수단을 활성화합니다.")
    Response<Void> activateAlertMethod(Long alertMethodId);
}
